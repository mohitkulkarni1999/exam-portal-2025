...
import { Eye, EyeOff, GraduationCap, User, Mail, Phone, Calendar, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white">Join as Student</h2>
          <p className="mt-2 text-green-200">Create your student account</p>
        </div>
